...
- **Continuation resends must preserve cross-file consistency**: the recovery prompt tells the model the other files WERE saved and it must keep every feature/id/function they reference, simplifying internals only. (v1.3.0 lacked this; a resent script.js dropped the scoreboard wiring index.html referenced, causing a student-visible sync bug.)
